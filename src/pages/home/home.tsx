...
const playList = [
  {
    id: 1,
    image:
      "https://m.doosanartcenter.com/upload/contentsImage/24111911355853723845.jpg",
    title: "고스트 베이커리",
    genre: "뮤지컬",
    review_num: 99,
  },
...
const Home = () => {
  ...
  const handleScroll = () => {
    ...
    setWhiteHeader(scrollPosition > 20);
  };
  ...
  return (
    <div className="home">
      ...
      <div className="contents">
        <div className="title">지금 인기있는 공연</div>
      ...
      <div className="contents">
        <div className="title">지금 인기있는 페어</div>
